"""
Central JSON configuration loader for Domain 9: Legal, Regulatory & Intellectual Property Intelligence.
...
Environment variable overrides (highest precedence):
  VEXER_LRI_CONFIG_PATH  -> alternate config file path
"""
import json
import os
...
def load_config(path: Optional[str] = None) -> Dict[str, Any]:
    ...
    config_path = path or os.getenv("VEXER_LRI_CONFIG_PATH", DEFAULT_CONFIG_PATH)
